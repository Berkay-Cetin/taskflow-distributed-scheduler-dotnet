...
export default function App() {
  ...
  // Kart seçilince tablo da o task'a göre filtrele
          ...
          <div className="flex-1">
            {tasks.length > 0 && !selected && (
              <div className="flex items-center gap-2 text-slate-500 text-xs mb-3
                ...
                <span>Click on a task card to view its execution history and filter the table below</span>
              </div>
            )}
